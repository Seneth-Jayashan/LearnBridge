...
const StudentSidebar = ({ isOpen, close, isExpanded, setIsExpanded }) => {
  ...
  const isOnQuizPage = location.pathname.includes("/student/quiz") || location.pathname.includes("/student/results") || location.pathname.includes("/student/quizzes");
        ...
        <nav className="flex-1 py-6 flex flex-col gap-1.5 overflow-y-auto custom-scrollbar overflow-x-hidden">
          ...
          <div>
            ...
            >
              ...
              <FiCheckSquare className={`w-5 h-5 shrink-0 transition-transform duration-200 ${!isOnQuizPage && "group-hover:scale-110"} ${isOnQuizPage ? "text-[#4CAF50]" : "text-slate-400 group-hover:text-[#4CAF50]"}`} />
