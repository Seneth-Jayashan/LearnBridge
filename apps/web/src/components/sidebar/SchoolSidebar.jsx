...
import { FiHome, FiUsers, FiUserCheck, FiLayout, FiSettings, FiChevronLeft, FiChevronRight, FiBriefcase, FiLogOut, FiClipboard } from "react-icons/fi";
          ...
          <div className="flex items-center gap-3 overflow-hidden w-full">
            ...
            {isExpanded && (
              <div className="flex flex-col animate-in fade-in duration-300">
                ...
                <span className="text-[10px] font-bold text-[#4CAF50] tracking-widest uppercase">Admin</span>
              </div>
            )}
          </div>
        </div>
