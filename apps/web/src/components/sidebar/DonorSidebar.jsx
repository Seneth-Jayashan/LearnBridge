...
import { FiHome, FiHeart, FiPieChart, FiSearch, FiUser, FiChevronLeft, FiChevronRight, FiLogOut } from "react-icons/fi";
...
const DonorSidebar = ({ isOpen, close, isExpanded, setIsExpanded }) => {
  ...
  const links = [
    ...
    { name: "Settings", path: "/donor/settings", icon: FiUser }, 
  ];
          ...
          <div className="flex items-center gap-3 overflow-hidden w-full">
            ...
            {isExpanded && (
              <div className="flex flex-col animate-in fade-in duration-300">
                ...
                <span className="text-[10px] font-bold text-[#4CAF50] tracking-widest uppercase">Community</span>
              </div>
            )}
          </div>
        </div>
