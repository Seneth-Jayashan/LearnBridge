...
const TeacherSidebar = ({ isOpen, close, isExpanded, setIsExpanded }) => {
  ...
  // When sidebar shrinks, close the dropdown
        ...
        <nav className="flex-1 py-6 flex flex-col gap-1.5 overflow-y-auto custom-scrollbar overflow-x-hidden">
          ...
          <div>
            ...
            >
              ...
              {/* Quiz icon — pencil + list combo */}
              <FiEdit3 className={`w-5 h-5 shrink-0 transition-transform duration-200
            ...
            {/* Dropdown items — only visible when expanded + open */}
                ...
                {quizLinks.map((link) => {
                  ...
                  return (
                    <Link
                      ...
                      `}
                    >
                      {/* Subtle left accent for active sub-item */}
                      {isActive && (
